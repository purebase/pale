...
fun sha256hashstring(legeerklaering: Legeerklaring): String {
    ...
    duplicateChekedFields.append(legeerklaering.legeerklaringGjelder.firstOrNull()?.typeLegeerklaring)
    ...
    duplicateChekedFields.append(legeerklaering.pasientopplysninger?.pasient?.arbeidsforhold?.virksomhet?.virksomhetsAdr?.postalAddress?.firstOrNull()?.streetAddress)
    duplicateChekedFields.append(legeerklaering.pasientopplysninger?.pasient?.arbeidsforhold?.virksomhet?.virksomhetsAdr?.postalAddress?.firstOrNull()?.postalCode)
    duplicateChekedFields.append(legeerklaering.pasientopplysninger?.pasient?.arbeidsforhold?.virksomhet?.virksomhetsAdr?.postalAddress?.firstOrNull()?.city)
    duplicateChekedFields.append(legeerklaering.pasientopplysninger?.pasient?.arbeidsforhold?.virksomhet?.virksomhetsAdr?.postalAddress?.firstOrNull()?.country)
    ...
    duplicateChekedFields.append(legeerklaering.diagnoseArbeidsuforhet?.diagnoseKodesystem?.enkeltdiagnose?.firstOrNull()?.diagnose)
    duplicateChekedFields.append(legeerklaering.diagnoseArbeidsuforhet?.diagnoseKodesystem?.enkeltdiagnose?.firstOrNull()?.kodeverdi)
    duplicateChekedFields.append(legeerklaering.diagnoseArbeidsuforhet?.diagnoseKodesystem?.enkeltdiagnose?.firstOrNull()?.sortering)
    ...
    duplicateChekedFields.append(legeerklaering.forslagTiltak?.aktueltTiltak?.firstOrNull()?.typeTiltak)
    duplicateChekedFields.append(legeerklaering.forslagTiltak?.aktueltTiltak?.firstOrNull()?.hvilkeAndreTiltak)
    ...
    duplicateChekedFields.append(legeerklaering.vurderingFunksjonsevne?.arbeidssituasjon?.firstOrNull()?.arbeidssituasjon)
    duplicateChekedFields.append(legeerklaering.vurderingFunksjonsevne?.arbeidssituasjon?.firstOrNull()?.annenArbeidssituasjon)
    ...
    duplicateChekedFields.append(legeerklaering.kontakt?.firstOrNull()?.kontakt)
    duplicateChekedFields.append(legeerklaering.kontakt?.firstOrNull()?.annenInstans)
