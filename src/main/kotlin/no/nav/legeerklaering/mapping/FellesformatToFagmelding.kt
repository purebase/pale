...
import no.nav.legeerklaering.model.Kontakt
import no.nav.legeerklaering.model.Pasient
import no.nav.legeerklaering.model.Prognose
...
operator fun Iterable<no.nav.model.legeerklaering.Kontakt>.contains(kontaktType: KontaktType): Boolean =
